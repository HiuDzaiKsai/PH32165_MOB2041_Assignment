...
import com.example.ph32165_mob2041_assignment.dao.ThuThuDao;
...
public class Login_Screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed_txtuser = findViewById(R.id.edTenDN);
        ed_txtpass = findViewById(R.id.edMatKhau);
        in_user = findViewById(R.id.in_User);
        in_pass = findViewById(R.id.in_Pass);
        btnLogin = findViewById(R.id.btnDangNhap);
        btnCancel = findViewById(R.id.btnHuyDN);
        chkSave = findViewById(R.id.chkLuuTK);
